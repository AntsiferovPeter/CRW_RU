...
и прибыли;</p></li>
        ...
        <li><p>Улучшение репутации: Наличие профессионального и удобного сайта повышает доверие клиентов к компании и способствует улучшению ее репутации;</p></li>
    ...
    <ul>
        <li><p>Footer (Подвал) страницы содержит:</p></li>
            <ul>
                ...
                <li><p>Политика конфиденциальности (Будет дорабатываться).</p></li>
            </ul>
    </ul>
    <div align="center" id="Images">
...
под слайдером, стрелочками по бокам, а для сенсорных экранов предусмотрено управление пальцем (Свайп);</p></li>
    ...
    <br>
    <br>
    <p>Блок контента страницы аутентификации содержит форму для заполнения.</p>
</div>
